...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        self.tiles[pos_tile]=max(self.tiles[pos_tile]-capacity, 0);
    ...
    def is_position_in_room(self, pos):
        ...
        """
        return 0<=pos.get_y() and pos.get_y()<self.height and 0<=pos.get_x() and pos.get_x()<self.width;
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        self.pos=Position(y=random.random()*self.room.height, x=random.random()*self.room.width);
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        return Position(x=random.random()*self.width, y=random.random()*self.height);
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_tile_furnished(self, m, n):
        ...
        """
        if (m,n) in self.furniture_tiles: return True;
        return False;
    ...
    def get_random_position(self):
        ...
        """
        while True:
            pos=Position(x=random.random()*self.width,y=random.random()*self.height);
            if(self.is_position_valid(pos)): return pos;
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        """
        next_pos=self.get_robot_position().get_new_position(self.get_robot_direction(), self.speed);
        #valid, just move
...
def run_simulation2(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
                  robot_type):
    """
    ...
    avrg_num_of_steps = []   # average number of steps for trial will be stored in this list.
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        cur=0;
        while True:
            if(room.get_num_cleaned_tiles()/room.get_num_tiles()>=min_coverage): break;
            for robot in robots:
